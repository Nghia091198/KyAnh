...
//         $(".page-active .header-bottom").appendTo(".page-active .header-about");
//         let imgURL = $(".page-active .header-left img");
//         imgURL.attr("src","./img/lg.png");
//     }
// }
// function height (el) {
//     var height = 100;
...
function changeNav () {
    ...
    let headerScroll = $(".header-2").css({"display":"flex"});
    if (headerScroll) {
        console.log("a");
    }
}
